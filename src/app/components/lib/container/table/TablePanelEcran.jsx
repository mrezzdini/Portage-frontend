...
import TableEcran from './TableEcran';
...
const TablePanelEcran = ({
    ...
    return (
        <div className={className}>
            ...
            <TableEcran data={{ column, rows }} onSort={onSort} />
            <Pagination
...
export default TablePanelEcran;

TablePanelEcran.propTypes = {
